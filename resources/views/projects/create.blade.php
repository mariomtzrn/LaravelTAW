...
<form method="post" action="/projects">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control"  name="descripcion"rows="5" placeholder="Descripción..." value="{{ old('descripcion') }}"></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="input-group">
     ...
     <input class="form-control" id="fecha_entrega" name="fecha_entrega" placeholder="MM/DD/YYYY" type="text" value="{{ old('fecha_entrega') }}"/>
    </div>
    <div class="form-group">
